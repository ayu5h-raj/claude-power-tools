...
when_to_use: "Use when the user wants to review, organize, or promote their auto-memory entries. Also useful for cleaning up outdated or conflicting entries across CLAUDE.md, CLAUDE.local.md, and auto-memory. Triggers: 'review memory', 'clean up memory', 'organize memory', 'promote memories', 'memory review'"
allowed-tools:
  - Read
  - Write
  - Edit
