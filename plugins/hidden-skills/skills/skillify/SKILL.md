...
when_to_use: "Use when the user wants to capture, save, or extract a repeatable workflow from the current session into a skill. Triggers: 'save this as a skill', 'make this a skill', 'capture this workflow', 'skillify this', 'turn this into a command'"
allowed-tools:
  - Read
  - Write
  - Edit
